...
enum AppCopyKey: Hashable {
    ...
    case today, currentLesson, noLessonsToday, noRemainingLessons, seeAll
...
private enum CopyBook {
    ...
    private static let english: [AppCopyKey: String] = [
        .welcome: "Welcome to Librebus", .goodToSee: "Good to see you", .connecting: "Connecting to Librus…", .tagline: "Your school day, in one calm place.",
        ...
        .schoolLogin: "School-issued login", .password: "Password", .passwordStored: "Your password is stored only in this device's Keychain. Librebus connects directly to Librus; no separate server is required.",
        .signIn: "Sign in", .signingIn: "Signing in…", .home: "Home", .grades: "Grades", .schedule: "Schedule", .messages: "Messages", .more: "More",
        .today: "Today", .currentLesson: "Current lesson", .noLessonsToday: "No lessons today", .noRemainingLessons: "No remaining lessons today", .seeAll: "See all",
    ...
    private static let polish: [AppCopyKey: String] = [
        .welcome: "Witaj w Librebus", .goodToSee: "Dobrze Cię widzieć", .connecting: "Łączenie z Librusem…", .tagline: "Twój dzień szkolny w jednym spokojnym miejscu.",
        ...
        .schoolLogin: "Login szkolny", .password: "Hasło", .passwordStored: "Hasło jest przechowywane tylko w pęku kluczy tego urządzenia. Librebus łączy się bezpośrednio z Librusem — osobny serwer nie jest potrzebny.",
        .signIn: "Zaloguj się", .signingIn: "Logowanie…", .home: "Start", .grades: "Oceny", .schedule: "Plan lekcji", .messages: "Wiadomości", .more: "Więcej",
        .today: "Dzisiaj", .currentLesson: "Trwająca lekcja", .noLessonsToday: "Brak lekcji dzisiaj", .noRemainingLessons: "Brak pozostałych lekcji dzisiaj", .seeAll: "Zobacz wszystkie",
